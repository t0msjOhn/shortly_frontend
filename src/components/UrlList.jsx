...
export default function UrlList({ urlList, deleteLink }) {
    ...
    async function handleDelete(code) {
        try {
            await axios.delete(`https://shortly-bgtu.onrender.com/api/links/${code}`);
            deleteLink(code);
    ...
    async function viewStats(code) {
        try {
            const response = await axios.get(`https://shortly-bgtu.onrender.com/api/stats/${code}`);
                            ...
                            {openCode === element.code && (
                                <div className="p-4 bg-gray-100 rounded-md shadow-md mt-2">
                                    ...
                                    <ul className="text-left list-none">
                                        ...
                                        <li>Shortened URL:<a target="_blank" href={`https://shortly-bgtu.onrender.com/${stats.slug}`}>https://shortly-bgtu.onrender.com/{stats.slug}</a></li>
